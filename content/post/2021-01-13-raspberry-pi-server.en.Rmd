...
Download "Raspberry Pi Imager" from the [official site](https://www.raspberrypi.com/software/), install it in your system, execute it, select Raspberry Pi OS Lite (32-bit) as the "Operating System", choose your "SD Card" and press "Write"
