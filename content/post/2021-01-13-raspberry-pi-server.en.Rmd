...
raspberry_01 ansible_host=192.168.3.101 # This is the hostname and IP for an individual Raspberry Pi
...
r_version: '' # (e.g. '4.3.1') Currently, you can only choose the R version if it's going to be
