...
cd /usr/local/src
sudo wget https://cran.rstudio.com/src/base/R-3/R-3.6.3.tar.gz
sudo su
...
```{bash eval=FALSE}
wget https://cmake.org/files/v3.17/cmake-3.17.0.tar.gz # Check for the latest version at  https://cmake.org/files/
