...
Descarga "Raspberry Pi Imager" del [sitio oficial](https://www.raspberrypi.com/software/), e instálalo en tu sistema, para la versión de 32-bits sólo necesitas ejecutar Raspberry Pi Imager, seleccionar Raspberry Pi OS Lite (32-bits) como el "Sistema Operativo", elegir tu "Tarjeta SD" y presionar "Escribir". Si quieres usar la versión de 64-bits, ya que es una versión beta, necesitas descargar manualmente la última versión lite de 64-bits del [repositorio Raspberry Pi oficial](https://downloads.raspberrypi.org/raspios_lite_arm64/images/) y elegir "Use costume" en Raspberry Pi Imager para seleccionar el archivo zip descargado.
