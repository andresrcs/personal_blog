...
Descarga "Raspberry Pi Imager" del [sitio oficial](https://www.raspberrypi.com/software/), instálalo en tu sistema, ejecútalo, selecciona Raspberry Pi OS Lite (32-bits) como el "Sistema Operativo", elije tu "Tarjeta SD" y presiona "Escribir"
