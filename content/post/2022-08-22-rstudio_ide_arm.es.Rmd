...
Otra opción es compilar la última versión de R tu mismo (4.2.2 al momento de escribir), esto lleva bastante tiempo pero brinda la mayor flexibilidad ya que puedes elegir opciones como compilar con BLAS y LAPACK:
